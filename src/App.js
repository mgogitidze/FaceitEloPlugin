...
function App() {
    ...
    const player = queryParameters.get("player")
    const [elo, setElo] = useState(0);

    const getApiData = async () => {
        const response = await fetch(
            `https://open.faceit.com/data/v4/players?nickname=${player}&game=cs2`, {
            ...
            <main>
                ...
                <div id="wrapper-red">
                    <span id="top">#850</span>
                        <svg viewBox="0 0 24 24" fill="#e80128" xmlns="http://www.w3.org/2000/svg" height="24"
                             width="24" className="sc-klVQfs hETIkZ">
